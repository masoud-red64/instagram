            ...
            .map((story, index) => (
              <>
                      ...
                      .map((story, index) => (
                        <SwiperSlide key={index}>
                          <div
                            ...
                            style={{
                              backgroundImage: "url(images/stories/img1.jfif)",
                            }}
                          >
                            {/* Top */}
                            <div className="flex items-center justify-between bg-gradient-to-b from-[rgba(38,38,38,.8)] to-[rgba(38, 38, 38,0)] pt-5 px-4 pb-8">
                              <div className="flex items-center gap-x-2">
                                <div className="w-8 h-8">
                                  <Story img="user16.jpg" hasStory={false} />
                                </div>
                ...
                <use href="#notifications"></use>
                            ...
                            >
                              <source
                                src="https://static.cdn.asset.aparat.com/avt/54105825_15s.mp4"
                                type="video/mp4"
                              />
                  ...
                  <div className="hidden prev-next__content">
                    <div className="w-[66px] h-[66px] pointer-events-none">
                      <Story img="user17.jpg" hasStory hasNewStory />
                    </div>
                    <span className="text-sm">perspolis</span>
